...
jira = JIRA(options={'server':'https://jira.charter.com', 'verify': False}, basic_auth=(username, password)) ## put this in settings.py file
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        while True:
            ...
            issues = jira.search_issues(jql,startAt=start_idx, maxResults=block_size,  fields=field_list )
            if len(issues) == 0:
                break
            block_num += 1
            for issue in issues:

...
def ip_linked_WriteToExcel():
    ...
    for element in range(0, length):
        try:
            ...
            Child_Key = parsed[element]['Child_Key']
            ...
            df_data = [CBOBBCM_Key,CBOBBCM_Summary,CBOBBCM_Status,CBOBBCM_Assignee,CBOBBCM_Created,Child_Key,Child_Summary,Child_Status,Child_Assignee,Child_Created,Grand_Child_Key,Grand_Child_Summary,Grand_Child_Status,Grand_Child_Assignee, Grand_Child_Created]# change elements to needs

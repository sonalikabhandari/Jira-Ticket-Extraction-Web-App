...
def op_linked_WriteToExcel():
    ...
    for element in range(0, length):
        try:
            ...
            df_data = [CBOBBCM_Key,CBOBBCM_Summary,CBOBBCM_Status,CBOBBCM_Assignee,CBOBBCM_Created,CBOBBOPPD_Key,Child_Summary,Child_Status,Child_Assignee,Child_Created,Grand_Child_Key,Grand_Child_Summary,Grand_Child_Status,Grand_Child_Assignee, Grand_Child_Created]# change elements to needs
    ...
    worksheet.write(0,5,"CBOBBOPPD_Key")
    ...
    writer.save()
    workbook.close()
    op_xlsx_data = output.getvalue()
    # op_xlsx_data contains the Excel file
    return op_xlsx_data
